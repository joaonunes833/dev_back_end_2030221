...
function processStudentResults(option){
    ...
    var medScore = 0;
    var closestScore = students[0]['score'];
    var closestName = students[0]['name'];
    ...
    // for (var i = 0; i < students.length; i++) {
    //     var toTest = students[i]['score'] - medScore;
    //     if (toTest < (closestScore-medScore) && toTest > 0) {
    //         closestScore = students[i]['score']
    //         closestName = students[i]['name']
    //     }
    //     else if (toTest > (closestScore-medScore) && toTest < 0) {
    //         closestScore = students[i]['score']
    //         closestName = students[i]['name']
    //     }
    // }
    ...
    if (option == 1) {
        ...
        console.log('A nota média é: ' + medScore /*+ ', O nota mais perto é: ' + closestScore + ', Aluno: ' + closestName + '.'*/)
    }
    else if (option == 5) {
